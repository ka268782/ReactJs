      ...
      <div className="row" id="row1">
        ...
        <ul className="nav navbar">
          <li className="dropdown">
            <a href="#" className="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span className="glyphicon glyphicon-user"></span>Kavitha G S<span className="caret"></span></a>
